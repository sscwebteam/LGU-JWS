...
<div class="art-nav-outer">
	<ul class="art-hmenu">
		<li>
			...
			<ul>
				<li>
                    <a href="./new-page/new-page-2.html">New Page 2</a>
...
<div class="art-block">
    <div class="art-block-body">
                <div class="art-blockheader">
                    <div class="l"></div>
                    <div class="r"></div>
                    <h3 class="t">New Block 2</h3>
                </div>
                <div class="art-blockcontent">
                    <div class="art-blockcontent-body">

<p> <span class="art-button-wrapper"><span class="art-button-l"> </span><span class="art-button-r"> </span><a title="click me" class="art-button">Save</a></span> <br /></p>
