...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["Juban Water System","User Credentials","Admin Panel","JWC Panel","Cashier Panel","Accounting Panel","LOGIN PANEL","Create/View new user","Bill a client","Ledger","Receivables and Receipts","Profile and Ledger Status","Names Per Barangay","New user form","View existing accounts","Create Ledger","Update Ledger","Delete Ledger"],
	DREX_NODE_LINKS: ["juban_water_system.htm","user_credentials.htm","admin_panel.htm","jwc_panel.htm","cashier_panel.htm","accounting_panel.htm","login_panel.htm","create_view_new_user.htm","bill_a_client.htm","ledger.htm","receivables_and_receipts.htm","profile_and_ledger_status.htm","names_per_barangay.htm","new_user_form.htm","view_existing_accounts.htm","create_ledger.htm","update_ledger.htm","delete_ledger.htm"],
	DREX_NODE_CHILD_START: [1,6,7,8,10,10,13,13,15,15,18,18,18,18,18,18,18,18],
	DREX_NODE_CHILD_END: [6,7,8,10,10,13,13,15,15,18,18,18,18,18,18,18,18,18],
	DREX_MENU_TYPE: 1,
