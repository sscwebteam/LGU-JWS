...
<table  class="ledger_2">
	<tr><th>Reading Date</th><th>Meter Reading</th><th>CU Used</th><th>PEN Fee</th><th>Bill Amount</th>
		<th>Loan MLP</th><th>Loan MF</th><th>Misc</th><th>Total</th><th>OR No</th><th>OR Date</th><th>Remarks</th>	
	</tr>
...
<!-- above has change date:june 12 2012 -->			
			...
			<td><input type="text" id="date" name="OR_date"></td>
	...
	<span style="margin-left:35%"><input type="button" class="art-button" onclick="if(confirm('Are you sure you want to enter these account values?')) document.ledger.submit();" value="Enter to Ledger"><a onclick="if(confirm('Continue to download?')) return true;return false;" href="download.php?action=download_ledger&data=<?php echo base64_encode($acct);?>"><input type="button" class="art-button" value="DOWNLOAD"></a></span>
		</form>
